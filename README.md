# ShowWave
[![ShowWave Image](.github/ShowWave.png)](https://docs.undi.rest)  
...
|----------------|------------------------------------------------------------------|----------------------------------------------------------|
| ShowWave Docs | [sudo-docs](https://docs.undi.rest)                          | [source code](https://github.com/sussy-code/docs)        |
...
| Frontend       | [ShowWave](https://docs.undi.rest/instances)                | [source code](https://github.com/sussy-code/smov)        |
...
## Running Locally
Type the following commands into your terminal / command line to run ShowWave locally
```bash
...
## Updating a ShowWave Instance
To update a ShowWave instance you can type the below commands into a terminal at the root of your project.
```bash
...
git commit -m "Update ShowWave instance (merge upstream/main)"
git push  # Push to YOUR repository
```


## Contact Me
**Email:** *[dev@ShowWave.lol](mailto:dev@ShowWave.lol)* 
